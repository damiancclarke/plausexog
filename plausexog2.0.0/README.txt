===============================================================================
README.txt for plausexog code version 2.0.0

yyyy-mm-dd: 2014-08-16
...
Version 2.0.0 has added the feature to use any distribution for the LTZ approch
instead of assuming a Gaussian prior as described by Conley et al.
